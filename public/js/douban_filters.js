...
const doubanFilterOptions = {
    ...
    theme: { 
        paramName: 'genres', 
        label: '筛选主题',
        options: ['全部', '喜剧', '爱情', '动作', '科幻', '动画', '悬疑', '犯罪', '惊悚', '冒险', '音乐', '历史', '奇幻', '恐怖', '战争', '传记', '歌舞', '武侠', '情色', '灾难', '西部', '纪录片','女优明星', '韩国主播', '欧美无码', '短片']
    },
    region: { 
        paramName: 'countries', 
        label: '地区',
...
function initOldApiFilterUIWithMatchedButtons(containerId) {
    ...
    const commonMovieTags = ['热门', '最新', '经典', '豆瓣高分', '冷门佳片', '华语', '欧美', '韩国', '日本', '动作', '喜剧', '爱情', '科幻', '悬疑', '恐怖', '治愈', '动画', '综艺', '纪录片', '女优明星', '韩国主播', '欧美无码','短片'];
    ...
    let movieSpecificTags = ['热门', '最新', '经典', '豆瓣高分', '冷门佳片', '华语', '欧美', '韩国', '日本', '动作', '喜剧', '爱情', '科幻', '悬疑', '恐怖', '治愈', '剧情', '战争', '奇幻', '冒险', '犯罪', '惊悚', '家庭', '古装', '武侠', '音乐', '歌舞', '传记', '历史', '西部', '黑色电影', '情色', '灾难','女优明星', '韩国主播', '欧美无码', '儿童'];
